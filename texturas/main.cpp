...
* Exercicio 1
*
* fazer uma foto com terreno com textura de grama e um céu com nuvens
*
* Fundo céu  (plano no eixo y)
* -------------
*  grama na horizontal (plano no eixo x)
*
*
*  Exercío 2
*  Na mesma foto do exercício 1, adicionar uma caixa de madeira rotacionando 
**/
...
void init()
{
   ...
   img1 = new Bmp("artjonny.bmp");
   img1->convertBGRtoRGB();
   data = img1->getImage();
//	data = stbi_load("ship1.jpg", &width, &height, &nrChannels, 0);
   if( data != NULL )
   {
      glEnable(GL_TEXTURE);
